...
export default function SidePanel() {
	...
	return (
		<motion.div
			...
			className="rounded-2xl border border-border-visible bg-surface-raised p-5 backdrop-blur"
		>
			...
			<div className="mt-5 rounded-xl border border-border-visible bg-surface-base p-4">
