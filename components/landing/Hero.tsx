  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background: 'radial-gradient(circle, hsl(36, 30%, 70%) 0%, transparent 70%)',
          filter: 'blur(80px)',
          y: prefersReducedMotion ? 0 : y,
        }}
        animate={prefersReducedMotion ? {} : { scale: [1, 1.1, 1], rotate: [0, 180, 360] }}
        transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
      />
      <motion.div
        className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full opacity-15"
        style={{
          background: 'radial-gradient(circle, hsl(32, 28%, 66%) 0%, transparent 70%)',
          filter: 'blur(60px)',
        }}
        animate={prefersReducedMotion ? {} : { scale: [1.1, 1, 1.1], rotate: [360, 180, 0] }}
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center justify-center">
          ...
          <div className="text-center pt-8 lg:pt-16 max-w-xl">
            ...
            >
              ...
              <span className="text-gradient">generated as LaTeX.</span>
            </motion.h1>
            ...
            >
              Paste a job description + your resume. Get an ATS-friendly PDF and LaTeX source in minutes.
            </motion.p>
          ...
          >
            <div className="bg-card-gradient rounded-2xl border border-border/50 p-6 shadow-card">
              ...
              <div className="flex items-center gap-6 mb-6">
                ...
                <div>
                  <h3 className="font-display text-lg font-medium text-foreground mb-1">ATS Score</h3>
                  <p className="text-sm text-muted-foreground">Optimized for tracking systems</p>
                </div>
              </div>
              ...
              <div className="border-t border-border/50 pt-4 mb-6">
                ...
                <div className="space-y-2">
                  {['Action verbs optimized', 'Skills section enhanced', 'ATS-safe formatting'].map((item, i) => (
                    <motion.div
                      key={item}
                    ...
                    >
                      <CheckCircle2 size={14} className="text-sand" />
                      {item}
                    </motion.div>
                  ))}
                </div>
