...
function LoginForm() {
	...
	return (
		<div className="w-full max-w-md rounded-2xl border border-border-visible bg-surface-raised p-8 text-text-primary shadow-card">
			...
			<p className="mt-5 text-center text-xs text-text-secondary">
				...
				<Link href={`/auth/signup?next=${encodeURIComponent(nextUrl)}`} className="text-text-primary font-medium hover:underline">
					Sign up
				</Link>
			</p>
		</div>
