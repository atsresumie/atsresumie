...
function LoginForm() {
	...
	return (
		<div className="w-full max-w-md rounded-2xl border border-[rgba(233,221,199,0.12)] bg-[rgba(20,14,11,0.95)] p-8 text-[#E9DDC7] shadow-[0_30px_100px_rgba(0,0,0,0.6)] backdrop-blur-xl">
			...
			<p className="mt-5 text-center text-xs text-[rgba(233,221,199,0.5)]">
				...
				<Link href={`/auth/signup?next=${encodeURIComponent(nextUrl)}`} className="text-[#E9DDC7] hover:underline">
					Sign up
				</Link>
			</p>
		</div>
